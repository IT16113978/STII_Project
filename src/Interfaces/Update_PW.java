...
public class Update_PW extends javax.swing.JFrame {
    ...
    private void SaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_SaveActionPerformed
        ...
        if ( x==0 ) {
            ...
            id = ID.getText ();
            new_pwd = NPassword.getText ();
            c_new_pwd = CNPassword.getText ();
            
            if ( "".equals ( new_pwd ) || "".equals ( c_new_pwd ) ) {
                ...
                if ( new_pwd.equals ( c_new_pwd )) {
        
                    try {
            
                        sql = "UPDATE login SET Password = '"+ new_pwd +"' WHERE Username = '"+ id +"' ";
    ...
    public static void main ( String args [] ) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Update_PW.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
