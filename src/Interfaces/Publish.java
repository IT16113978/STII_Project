...
public class Publish extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Publish Notices");
        ...
        Publish.setFont(new java.awt.Font("Tahoma", 1, 24)); // NOI18N
    ...
    private void PublishActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_PublishActionPerformed
        ...
        title = Title.getText ();
        pubnotice = Notice.getText ();
        
        try {
            
            sql = "INSERT INTO notice ( Title, Notice ) VALUES ( '"+ title +"', '"+ pubnotice +"' )";
            pst = con.prepareStatement ( sql );
            pst.execute ();
            
            JOptionPane.showMessageDialog ( null, "Publish Succesful" );
